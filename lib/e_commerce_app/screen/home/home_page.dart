...
import 'package:my_cart_express/e_commerce_app/widget/small_product_view.dart';
...
class HomePage extends StatelessWidget {
                ...
                Expanded(
                  child: TextFormFieldWidget(
                    ...
                    onTap: () {
                      ...
                      Get.toNamed(Routes.search)?.then((_) {
                        FocusScope.of(context).unfocus();
                      });
                    },
                  ),
  ...
  Widget categoryView(BuildContext context, HomeController _) {
    return Column(
      children: <Widget>[
        Padding(
  ...
  Widget bestSellerView(BuildContext context, HomeController _) {
    return Column(
      children: <Widget>[
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 15),

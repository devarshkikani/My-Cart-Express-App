...
class FavoritesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SizedBox(
        height: Get.height,
        child: GetBuilder<FavoritesScreenController>(
          init: FavoritesScreenController(),
          builder: (_) => Column(
            children: <Widget>[
              dividers(0),
              Expanded(
  ...
  Widget favoritesList(BuildContext context, FavoritesScreenController _) {
  ...
  Widget cartDecoration(
      BuildContext context, FavoritesScreenController _, int index) {
    return Container(

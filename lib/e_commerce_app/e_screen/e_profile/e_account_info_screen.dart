...
import 'package:my_cart_express/e_commerce_app/e_constant/e_enum.dart';
...
class EAccountInfoScreen extends StatelessWidget {
  const EAccountInfoScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: GetX<EAccountInfoScreenController>(
          builder: (_) {
            return Text(
      ...
      body: SizedBox(
        ...
        child: Column(
          children: <Widget>[
            ...
            Expanded(
              child: SingleChildScrollView(
                child: Padding(
                  ...
                  child: GetX<EAccountInfoScreenController>(
                    builder: (_) {
            ...
            height10,
            GetX<EAccountInfoScreenController>(
              builder: (_) {
  ...
  Widget editProfileView(BuildContext context, EAccountInfoScreenController _) {
    return Column(
      children: <Widget>[
        EmailWidget(
          hintText: 'Email',
  ...
  Widget editPasswordView(
      BuildContext context, EAccountInfoScreenController _) {
    return Column(
      children: <Widget>[
        PasswordWidget(
          passType: 'Password',

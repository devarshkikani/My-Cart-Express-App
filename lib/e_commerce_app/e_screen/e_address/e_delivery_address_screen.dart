...
class EDeliveryAddressScreen extends GetView<EDeliveryAddressScreenController> {
  const EDeliveryAddressScreen({super.key});
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () {
                  Get.toNamed(ERoutes.addNewAddress);
                },
                child: Container(
                  height: 45,
            ...
            SizedBox(
              ...
              child: eElevatedButton(
                ...
                onTap: () {
                  Get.toNamed(ERoutes.paymentMethod);
                },
              ),
            ),
            height15,

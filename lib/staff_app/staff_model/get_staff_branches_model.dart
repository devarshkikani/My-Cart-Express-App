...
GetStaffAllBranches getStaffAllBranchesFromJson(String str) =>
    GetStaffAllBranches.fromJson(json.decode(str));

String getStaffAllBranchesToJson(GetStaffAllBranches data) =>
...
class GetStaffAllBranches {
  ...
  factory GetStaffAllBranches.fromJson(Map<String, dynamic> json) =>
      GetStaffAllBranches(
        status: json["status"],
        message: json["message"],
        staffBranches: json["staff_branches"] == null
            ? []
            : List<StaffBranch>.from(
                json["staff_branches"]!.map((x) => StaffBranch.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "status": status,
        "message": message,
        "staff_branches": staffBranches == null
            ? []
            : List<dynamic>.from(staffBranches!.map((x) => x.toJson())),
      };
}
...
class GetDrawerStatusModel {
  ...
  GetDrawerStatusModel.fromJson(Map<String, dynamic> json) {
    ...
    drawerDetails = json['drawer_details'] != null
        ? DrawerDetails.fromJson(json['drawer_details'])
        : null;
    message = json['message'];
  }
